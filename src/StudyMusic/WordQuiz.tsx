...
export default function WordQuiz (props : any) {
  ...
  const generateQuiz = (correctAnswer: any, allAnswers: any) => {
    const wrongAnswers = shuffle(allAnswers.filter((answer: any) => answer.word !== correctAnswer.word)).slice(0, 3);
...

      {
        ...
        <View style={styles.section}>
          ...
          <View style={{height:150, borderWidth:2, borderColor:'#BDBDBD', borderRadius:10, alignItems:'center', justifyContent:'center', padding:15}}>
            <Typography fontSize={18} fontWeightIdx={1}>{propsData[currentQuizIndex].meaning}</Typography>
