...
export default function LyricsAriaList (props : any) {
  ...
  const fetchPosts = () => {
    axios.get(`${MainURL}/study/getsongdataall/Aria/${nation}/${alphabet}`).then((res) => {
      if (res.data !== false) {
                    ...
                    songsLast.map((item:any, index:any)=>{
                      ...
                      return (
                        <TouchableOpacity
                          ...
                          onPress={()=>{
                            props.navigation.navigate('LyricsDetail', { songID : item.id, sort : 'Aria', nation : nation })
                          }}
                        >
                          <View>
