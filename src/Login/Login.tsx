...
export default function Login (props : any) {
      ...
      axios
          ...
          .then((res: any)=>{
            if (res.data.isUser === true) {
              AsyncSetItem(res.data.refreshToken, res.data.userAccount, res.data.userName, res.data.userSchool, res.data.userSchNum, res.data.userPart, res.data.userURL);
  ...
  // 네이버 로그인
  const consumerKey = 'NJivxK1ooCxnPodocRjp';
  const consumerSecret = 'SkpvsxS_Ba';
  const appName = 'com.studentsclassic.app';
  const serviceUrlScheme = 'com.studentsclassic.app';
